...
const Login = () => {
    ...
    const { logInWithEmailAndPassword, signInWithGoogle, signInWithGithub } = useContext(AuthContext);
    ...
    function handleMediaLogin(media) {
        media().then(() => {
            navigate(location.state ? location.state : '/');
                    ...
                    <div className="max-w-md w-full border py-8 px-6 rounded border-gray-300 bg-white">
                        ...
                        <form className="mt-10 space-y-4" onSubmit={handleLogIn}>
                            ...
                            <div className="space-x-6 flex justify-center">
                                <button type="button" onClick={() => handleMediaLogin(signInWithGoogle)}
                                    className="border-none outline-none hover:scale-110 transition-all">
                                ...
                                <button type="button" onClick={() => handleMediaLogin(signInWithGithub)}
                                    className="border-none outline-none hover:scale-110 transition-all">
