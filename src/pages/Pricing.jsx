                    ...
                    <div className="grid lg:grid-cols-3 sm:grid-cols-2 gap-8 mt-12 max-sm:max-w-sm max-sm:mx-auto">
                        <div className="border rounded-md p-6">
                            ...
                            <div className="mt-6">
                                ...
                                <button type="button" className="w-full mt-6 px-2 py-2 text-sm font-semibold text-white bg-blue-500 hover:bg-blue-600 rounded-md" onClick={handlePremiumSubscription}>Buy now</button>
                            </div>
                        </div>
                        <div className="border rounded-md p-6">
                            <h3 className="text-2xl font-semibold mb-1 flex items-center">Professional <span className="px-2 py-1 text-xs font-semibold text-white bg-blue-500 rounded-md ml-3">Best Deal</span></h3>
